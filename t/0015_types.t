...
my $i = 100;
my $v = t::NeoValue->_new_from_perl($i);
is $v->_neotype, "Integer", "Integer";
is $v->_as_perl, $i, "roundtrip";
$i = 100.1;
$v = t::NeoValue->_new_from_perl($i);
...
$v = t::NeoValue->_new_from_perl({ _relationship => 154732534, _start => 53243, _end => 235367, _type => "IS_THING", these => "are", some => "props" });
...
$v = t::NeoValue->_new_from_perl({ _relationship => 154732534, _start => 53243, _end => 235367, _type => "IS_THING"});
...
$v = t::NeoValue->_new_from_perl({ _relationship => 154732534, _start => 53243, _end => 235367});
...
TODO: {
  ...
  $v = t::NeoValue->_new_from_perl( [ {_node => 1234}, {_relationship=>523, _start => 1234, _end => 5678, _type => "try"}, {_node => 5678} ] );
